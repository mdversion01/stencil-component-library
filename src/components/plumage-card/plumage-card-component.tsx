...
@Component({
  tag: 'plumage-card-component',
  styleUrl: 'plumage-card.scss',
  shadow: false,
})
export class PlumageCardComponent {
  ...
  private resolveBaseId() {
    ...
    PlumageCardComponent._seq += 1;
    const rnd = Math.random().toString(36).slice(2, 6);
    this._baseId = `card-${PlumageCardComponent._seq}-${rnd}`;
  }
