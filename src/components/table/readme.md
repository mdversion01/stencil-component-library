...
| `expandedRows`           | `expanded-rows`            |             | `number[]`                                                                                                       | `[]`                       |
| `fields`                 | `fields`                   |             | `Field[]`                                                                                                        | `[]`                       |
...
| `pageSizeOptions`        | `page-size-options`        |             | `(number \| "All")[]`                                                                                            | `[10, 20, 50, 100, 'All']` |
...
| `selectedFilterFields`   | `selected-filter-fields`   |             | `string[]`                                                                                                       | `[]`                       |
...
| `size`                   | `size`                     |             | `"" \| "sm"`                                                                                                     | `''`                       |
| `sortCriteria`           | `sort-criteria`            |             | `{ key: string; order: "none" \| SortOrder; }[]`                                                                 | `[]`                       |
