...
| `rangeFillMode`    | `range-fill-mode`     |             | `"inside" \| "outside"`                                                                    | `'inside'`     |
...
| `stringValues`     | `string-values`       |             | `string \| string[]`                                                                       | `[]`           |
| `tickLabels`       | `tick-labels`         |             | `boolean`                                                                                  | `false`        |
| `tickValues`       | `tick-values`         |             | `number[] \| string`                                                                       | `[]`           |
| `type`             | `type`                |             | `"basic" \| "discrete" \| "multi"`                                                         | `'basic'`      |
| `unit`             | `unit`                |             | `string`                                                                                   | `''`           |
