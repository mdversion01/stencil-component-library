...
| `customClass`  | `custom-class`  | Additional classes to apply to tooltip                                                                                   | `string`                                                                                   | `''`            |
...
| `tooltipId`    | `tooltip-id`    | Optional stable id for the tooltip element (recommended for tests/SSR). If omitted, a deterministic-ish id is generated. | `string`                                                                                   | `undefined`     |
