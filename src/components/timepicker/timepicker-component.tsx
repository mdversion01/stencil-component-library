...
@Component({
  ...
  styleUrls: ['./timepicker-styles.scss', '../utilities-styles.scss', '../button/button.scss', '../input-group/input-group-styles.scss', '../input-field/input-field-styles.scss'],
  shadow: false,
})
export class TimePickerComponent {
  ...
  private _disablePanel(dd: HTMLElement) {
    ...
    dd.removeAttribute('aria-hidden'); // rely on hidden + inert
