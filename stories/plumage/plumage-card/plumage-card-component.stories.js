// File: src/stories/plumage-card/plumage-card-component.stories.js

// import DocsPage from './card-component.docs.mdx';
import { DocsWrapStyles, buildDocsHtml, normalize, renderCard, wrapDocsHtml } from './plumage-card-component.story-helpers.js';

export default {
  title: 'Plumage/Plumage Card'
  ,
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: ['Plumage Card component for displaying content in a card layout.', ''].join('\n'),
      },
      source: {
        language: 'html',
