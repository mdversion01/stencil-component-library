// stories/plumage/plumage-accordion/plumage-accordion.stories.js
import { buildAccordion } from './plumage-accordion.story-helpers';

export default {
  title: 'Plumage/Plumage Accordion',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          'A Plumage Accordion Component belongs to the Plumage Accordion Container but can also be used on its own.\n',
...
export const PlumageAccordionWithCustomIcon = {
  args: {
    accordion: true,
...
export const AccessibilityMatrix = {
  ...
  render: (_args, context) => {
    ...
    wrap.className = 'plumage-accordion-accessibility-matrix';
    ...
    description.className = 'plumage-accordion-accessibility-matrix__description';
    ...
    const mkRow = (labelText, makeHost) => {
      ...
      row.className = 'plumage-accordion-accessibility-matrix__row';

      const left = document.createElement('div');
      left.className = 'plumage-accordion-accessibility-matrix__label';
      left.textContent = labelText;

      const right = document.createElement('div');
      right.className = 'plumage-accordion-accessibility-matrix__content';

      const demo = document.createElement('div');
      demo.className = 'plumage-accordion-accessibility-matrix__demo';

      const host = makeHost();
      demo.appendChild(host);

      const pre = document.createElement('pre');
      pre.className = 'plumage-accordion-accessibility-matrix__output';
