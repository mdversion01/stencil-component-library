...
export const Standard = {
  ...
  parameters: {
    docs: {
      source: { code: Template(baseArgs), language: 'html' },
      description: {
        story:
...
export const AccessibilityMatrix = {
  ...
  render: () => {
    ...
    const rows = [
      ...
      {
        title:
          'Error/Validation-ish (no rows: controls mostly disabled)',
        args: {
          variant: 'standard',
          currentPage: 1,
          totalRows: 0,
