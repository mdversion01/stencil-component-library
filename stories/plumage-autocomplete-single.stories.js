 ...
 * Goal: identical stories/args to autocomplete-single.stories.js,
 *       but using the Plumage component.
 * ------------------------------------------------------------------ */
...
/** Build docs HTML for the Plumage component (options applied at runtime, not as attribute) */
const buildDocsHtml = args =>
  normalize(`
  <plumage-autocomplete-single ${attrLines([
    // ✅ alphabetized (kebab-case) — same as autocomplete-single
...
const setOptionsWhenReady = async (el, options) => {
  ...
  await whenReady(el, 'plumage-autocomplete-single');
  el.options = safe;
};
...
// ======================================================
// Sample data (same as autocomplete-single)
// ======================================================

const DEFAULT_OPTIONS = ['Apple', 'Apparatus', 'Apple Pie', 'Applegate', 'Banana', 'Orange', 'Mango'];

// ======================================================
// Default export (same args + same stories as autocomplete-single)
// ======================================================
...
export default {
  ...
  render: (args, ctx) => {
    const el = document.createElement('plumage-autocomplete-single');

    // attributes (kebab-case) — identical set to autocomplete-single
  ...
  // ✅ identical argTypes to autocomplete-single (so controls match)
  argTypes: {
    /* =========================
     * Attributes
     * ========================= */
  ...
  // ✅ identical defaults to autocomplete-single (except ids to avoid collisions)
  args: {
    arialabelledBy: '',
    autoSort: true,
    ...
    formId: '',
    formLayout: '',
    id: 'plumage-aci-story',
    inputCol: 10,
    inputCols: '',
    inputId: 'plumage-ac-single',
...
// ======================================================
// Stories (IDENTICAL SET to autocomplete-single)
// ======================================================
...
// Sizes (sm, default "", lg) — same shape as autocomplete-single
const SIZE_VARIANTS = [
  { key: 'sm', label: 'Small', size: 'sm', inputId: 'plumage-ac-single-sm', id: 'plumage_ac_single_sm' },
  { key: 'default', label: 'Default', size: '', inputId: 'plumage-ac-single-md', id: 'plumage_ac_single_md' },
  { key: 'lg', label: 'Large', size: 'lg', inputId: 'plumage-ac-single-lg', id: 'plumage_ac_single_lg' },
];
...
export const Sizes = {
  ...
  parameters: {
    docs: {
      ...
      description: { story: 'Shows sizes by setting `size` to `sm`, empty string (default), and `lg`.' },
      story: { height: '480px' },
    },
  },
};
...
ControlledValue.parameters = {
  docs: {
    description: { story: 'Demonstrates the `value` prop as the external source of truth.' },
    story: { height: '380px' },
  },
};
...
FieldValidation.parameters = {
  docs: { description: { story: 'Shows external validation state + validation message.' }, story: { height: '300px' } },
};
